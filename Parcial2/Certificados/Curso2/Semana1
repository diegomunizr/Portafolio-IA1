# Semana 1 - Algoritmos Avanzados de Aprendizaje
...
- Las neuronas y el cerebro (Video • 10 min)
...
- Redes neuronales más complejas (Video • 8 min)
...
- Datos en TensorFlow (Video • 11 min)
...
- Cómo se implementan eficazmente las redes neuronales (Video • 4 min)
- Multiplicación de matrices (Video • 9 min)
- Reglas de multiplicación de matrices (Video • 9 min)
- Código de multiplicación de matrices (Video • 6 min)
...
| Archivo | Descripción |
|---------|-------------|
| [evidencia1.png](evidencia1.png) | Implementación de TensorFlow e Implementación de Redes Neuronales en Python - Completado |
| [evidencia2.png](evidencia2.png) | Vectorización y Laboratorio de Prácticas: Redes Neuronales - Completado |
