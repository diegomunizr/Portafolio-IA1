# Semana 3 - Algoritmos Avanzados de Aprendizaje
...
|-------|---------|
| **Plataforma** | Coursera |
| **Curso** | Algoritmos Avanzados de Aprendizaje |
| **Semana** | Semana 3 |
...
- Evaluar un modelo (Video • 10 min)
...
- Regularización y sesgo/varianza (Video • 10 min)
- Establecer un nivel de referencia del rendimiento (Video • 9 min)
- Curvas de aprendizaje (Video • 11 min)
- Decidir qué probar a continuación revisitado (Video • 8 min)
...
- Análisis de errores (Video • 8 min)
- Añadir datos (Video • 14 min)
- Aprendizaje por transferencia: utilizar datos de una tarea diferente (Video • 11 min)
...
- El equilibrio entre precisión y memoria (Video • 11 min)
...
| Archivo | Descripción |
|---------|-------------|
| [evidencia1.png](evidencia1.png) | Conjuntos de datos sesgados y Laboratorio de prácticas - Completado |
| [evidencia2.png](evidencia2.png) | Proceso de desarrollo del ML y Conjuntos de datos sesgados - Completado |
