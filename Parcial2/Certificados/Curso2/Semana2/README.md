# Semana 2 - Algoritmos Avanzados de Aprendizaje
...
- Softmax (Video • 11 min)
- Red neuronal con salida Softmax (Video • 7 min)
- Implementación mejorada de Softmax (Video • 9 min)
- Clasificación con múltiples salidas (Opcional) (Video • 4 min)
...
- Gráfico de cálculo (Video • 19 min)
- Ejemplo de red neuronal más grande (Video • 9 min)
- Laboratorio opcional: Derivados (Laboratorio • 30 min)
- Laboratorio opcional: Retropropagación (Laboratorio • 30 min)
...
| Archivo | Descripción |
|---------|-------------|
| [evidencia1.png](evidencia1.png) | Propagación hacia atrás y Laboratorio de prácticas - Completado |
| [evidencia2.png](evidencia2.png) | Conceptos adicionales y Propagación hacia atrás - Completado |
